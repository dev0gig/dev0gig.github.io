...
const TemplatesModal: React.FC<TemplatesModalProps> = ({ isOpen, onClose, onSelect, isMobileView }) => {
    ...
    return (
        <div role="dialog" aria-modal="true" className="fixed inset-0 z-[51] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fadeIn" onClick={onClose}>
            <div className="bg-zinc-800/90 backdrop-blur-xl border border-zinc-700/60 rounded-2xl shadow-lg w-full max-w-sm m-4 p-6 animate-scaleIn h-[70vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
                <div className="flex justify-between items-center mb-4 flex-shrink-0">
                    <h2 className="text-xl font-bold">Aus Vorlage laden</h2>
