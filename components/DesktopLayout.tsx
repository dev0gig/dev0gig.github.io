...
const DesktopLayout: React.FC<DesktopLayoutProps> = ({
  ...
  const isExternalProjectActive = activeExternalProjects.left !== null || activeExternalProjects.right !== null;
  const mainContentClass = isExternalProjectActive
  ...
  return (
    <div className="h-dvh w-full flex bg-zinc-900 text-zinc-100 antialiased">
      <Sidebar
        ...
        onExternalProjectSelect={onExternalProjectSelect}
        onExternalProjectContextMenu={onExternalProjectContextMenu}
        activeExternalProjects={activeExternalProjects}
        activeMyProject={activeMyProject}
        onMyProjectSelect={onMyProjectSelect}
      />
      <div className="flex-1 flex flex-col overflow-hidden">
        
        {!isExternalProjectActive && (
          <>
              ...
              <div className="flex items-center justify-start flex-1 min-w-0">
                {headerTitle && (
                    <div className="flex items-baseline space-x-3 overflow-hidden">
                        ...
                        {headerSubtitle && <p className="text-sm text-zinc-400 truncate">{headerSubtitle}</p>}
                    </div>
                )}
              </div>
            ...
            {showSearchBar && suggestedTags.length > 0 && (
